...
(() => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const lintEngine = {
        ...
        ignoreText({ text, message }) {
            var _a;
            return __awaiter(this, void 0, void 0, function* () {
                const ignoreSet = (_a = ignoreMarkMap.get(message.ruleId)) !== null && _a !== void 0 ? _a : new Set();
...
<ul>
    ...
    (_b = document.querySelector("#install")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
